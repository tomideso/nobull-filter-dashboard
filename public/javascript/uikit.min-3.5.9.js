...
!(function (t, e) {
        ...
        V(t).map(function (o) {
          return new ae(function (n, i) {
            ...
            Jt(
              ...
              w(e, tn) &&
                ze(o, a && "uk-transform-origin-" + a, u && tn + "reverse");
          });
        })
      )
    );
  ...
  function Yn(t, e) {
    ...
    var n = J(Xn(t)),
      ...
      a = Math.min(o, s + r);
    return tt(
      (-1 * (s - a)) / Math.min(an(t).height + e + a, i - (s + r), i - o)
    );
  }
  function Xn(t, e) {
      ...
      (i.prototype.$create = function (t, e, n) {
        ...
        (i.prototype.$destroy = function (t) {
          ...
          n && this._callDisconnected(),
            ...
            n &&
              n[r] &&
              (delete n[r][i], O(n[r]) || delete n[r], t && $e(this.$el));
        }),
          ...
          handler: function (t) {
            ...
            this.$el === e
              ? ((ki = this.isActive() ? null : ki),
                ...
                this.tracker.cancel())
              : (ki =
                  null === ki && qt(e, this.$el) && this.isToggled()
                    ? this
                    : ki);
          },
        },
  ...
  function Ai(t, e) {
    ...
    return (
      e && ((i = (n = hn(t))[0]), (r = n[1])),
      { top: i, left: r, bottom: i + o, right: r + s }
    );
  }
  var Ni = {
    extends: Ei,
      ...
      },
      {
        read: function (t) {
          ...
          return {
            scrolled:
              !!this.parallax &&
              Yn(this.$el, e ? e - ln(this.$el) : 0) * Math.abs(this.parallax),
          };
        },
        write: function (t) {
          var e = t.columns,
  ...
  function zi(t) {
    ...
    return (
      o &&
        s &&
        (Re(t, "minHeight", ""), (e = Bi(t)), (i = e.heights), (r = e.max)),
      {
    ...
    update: {
      read: function (t) {
        ...
        if (this.expand) {
          ...
          this.offsetTop &&
            (n +=
              0 < (r = an(this.$el).top) && r < ln(window) / 2
                ? " - " + r + "px"
                : ""),
            !0 === this.offsetBottom
        ...
        : this.isImg &&
          ...
          Qi(
            ...
            (function (t, e, n) {
              var i;
              n &&
                ((i = rt.ratio({ width: t, height: e }, "width", bn(er(n)))),
                (t = i.width),
                (e = i.height));
              return (
      ...
      update: [
        {
          read: function (t) {
            ...
            t.update &&
              this.elements.forEach(function (t) {
                t[$r] ||
                  (t[$r] = { cls: ut(t, "uk-scrollspy-class") || e.cls }),
      ...
      update: [
        {
          ...
          write: function (t) {
            ...
            this.links.forEach(function (t) {
              ...
              !1 !== e &&
                Kt(this.$el, "active", [e, ze(this.elements[e], this.cls)]);
          },
          events: ["scroll", "resize"],
        },
      ],
      ...
      update: [
        {
          read: function (t, e) {
            ...
            return (
              (this.top =
                Math.max(F(Er("top", this)), this.topOffset) - this.offset),
          ...
          write: function (t) {
            var e = t.height,
              ...
              i = this.placeholder;
            Re(i, G({ height: e }, n)),
              qt(i, document) || (ye(this.$el, i), (i.hidden = !0)),
  ...
  function Er(t, e) {
    ...
    if (o)
      return z(o) && o.match(/^-?\d/)
        ? r + bn(o)
        : an(!0 === o ? i.parentNode : yt(o, i)).bottom;
  }
  var _r,
    Cr,
    Ar,
      ...
      methods: {
        animate: function (t, i) {
          ...
          void 0 === i && (i = this.$el),
            (function () {
              if (Br) return;
              (Br = be(document.head, "<style>").sheet).insertRule(
                "." +
                  Pr +
            ...
            ae
              .all(
                r
                  ...
                  .concat(
                    e !== a &&
                      Qe.start(i, { height: a }, this.animation, "ease")
                  )
              )
              .then(function () {
                r.forEach(function (t, e) {
    ...
    h &&
      ...
      Y(
        (s = G([], n).sort(function (t, e) {
          return (
            ut(t, a).localeCompare(ut(e, a), void 0, { numeric: !0 }) *
            ("asc" === u || -1)
          );
        })),
        n
            ...
            if (
              ...
              [this.index, this.prevIndex]
                ...
                l &&
                  ((this.prevIndex = r),
                  (this.index = s),
                  d || Kt(c, "beforeitemhide", [this]),
                  Kt(h, "beforeitemshow", [this])),
                ...
                l &&
                  (d || Kt(c, "itemhide", [this]), Kt(h, "itemshow", [this]));
            }
          },
          end: function () {
            var t;
          ...
          if ((i[e ? "unshift" : "push"](t), !e && 1 < i.length))
            ...
            if (c !== l) {
              if (
                ...
                (this.prevIndex = u),
                (this.index = h),
                (c && !Kt(c, "beforeitemhide", [this])) ||
                  !Kt(l, "beforeitemshow", [this, c]))
              )
              ...
              return (
                c && Kt(c, "itemhide", [this]), Kt(l, "itemshow", [this]), d
              );
            }
            o();
          }
          ...
          return {
            ...
            show: function (t, e, n) {
              ...
              return (
                ...
                ae
                  .all([Qe.start(s, c[1], t, r), Qe.start(o, c[0], t, r)])
                  .then(function () {
                    i.reset(), h.resolve();
                  }, et),
                h.promise
            ...
            translate: function (t) {
              ...
              Re(s, e[1]),
                Re(o, e[0]),
                Jr(s, "itemtranslatein", { percent: t, dir: a }),
                Jr(o, "itemtranslateout", { percent: 1 - t, dir: a });
            },
            percent: function () {
              return n(o || s, s, a);
            },
              ...
              i &&
                ...
                "image" === e || i.match(/\.(jpe?g|png|gif|svg|webp)($|\?)/i)
                  ? fe(i, h.srcset, h.size).then(
                      function (t) {
                        ...
                        return o.setItem(
                          ...
                          eo(
                            "img",
                            G({ src: i, width: e, height: n, alt: s }, h)
                          )
                        );
                      },
                      function () {
                  ...
                  ? (Xt(
                      ...
                      "loadedmetadata",
                      function () {
                        ot(n, { width: n.videoWidth, height: n.videoHeight }),
                          o.setItem(r, n);
                      }
                    ),
                    Xt(n, "error", function () {
            ...
            if (
              (r
                ...
                ? ((u = "bgy" === e ? "height" : "width"),
                  ...
                  (i = Re(m, "backgroundPosition").split(" ")[
                    "x" === e[2] ? 0 : 1
                  ]),
                  (n = v.covers
      ...
      read: function (t, e) {
        ...
        if (("scroll" !== e && (n = !1), t.active)) {
          var i,
            ...
            o = n;
          return (
            (i = Yn(this.target) / (this.viewport || 1)),
            (r = this.easing),
            {
  ...
  function lo(t, e, n) {
    var i,
      r = go(t, e);
    return n
      ? r - ((i = t), an(e).width / 2 - an(i).width / 2)
      : Math.min(r, fo(e));
  }
  function fo(t) {
          ...
          return {
            ...
            translate: function (t) {
              ...
              Re(
                c,
                "transform",
                Yr(tt(e - e * t - l, -po(c), an(c).width) * (lt ? -1 : 1), "px")
              ),
            ...
            percent: function () {
              return Math.abs(
                (Re(c, "transform").split(",")[4] * (lt ? -1 : 1) + n) / (l - n)
              );
            },
            getDistance: function () {
              return Math.abs(l - n);
                ...
                this.slides.reduce(function (t, e, n) {
                  ...
                  return (
                    a < c + r &&
                      ...
                      b(t, n) ||
                        ((i = o.slides[n + 1]),
                        o.center && i && r < u - an(i).width / 2
                          ? (u -= r)
                          : ((u = s),
                            t.push(n),
                            (a = c + s + (o.center ? r / 2 : 0))))),
                    (c += r),
                    t
                  );
                }, []))
  ...
  var ko,
    ...
    Io = G({}, qr, {
      ...
      scale: {
        show: function () {
          return [
            { opacity: 0, transform: Xr(1.5), zIndex: 0 },
            { zIndex: -1 },
          ];
        },
        percent: function (t) {
        ...
        translate: function (t) {
          return [
            { opacity: 1 - t, transform: Xr(1 + 0.5 * t), zIndex: 0 },
            { zIndex: -1 },
          ];
        },
      },
      ...
      update: {
        write: function () {
          if (this.drag && Pt(this.placeholder)) {
            ...
            if (
              a &&
              !qt(s, this.placeholder) &&
              (!c || (a.group && a.group === u.group))
            ) {
              if (
                ((s =
              ...
              a.insert(this.placeholder, s),
                b(this.touched, a) || this.touched.push(a);
            }
          }
        },
        events: ["move"],
      ...
      methods: {
        ...
        start: function (t) {
          ...
          this.drag =
            ...
            (i = be(
              e,
              n.outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g, "$1div$2")
